...
from etwork import fields, models, api
...
class L10nLatamDocumentType(models.Model):
    ...
    internal_type = fields.Selection(
        ...
        help='Analog to etwork account.move.move_type but with more options allowing to identify the kind of document we are'
