...
from etwork import fields, models, api, _
from etwork.addons.iap.tools import iap_tools
from etwork.exceptions import AccessError, UserError
from etwork.tools.safe_eval import safe_eval

DEFAULT_ENDPOINT = 'https://iap-snailmail.etwork.com'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            ...
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.etwork.com</a> to claim your free credits.', link)
