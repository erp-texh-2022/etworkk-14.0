...
from etwork.tests import tagged, Form
...
from etwork.exceptions import AccessError, ValidationError, UserError
...
class TestChannelAccessRights(TestMailCommon):
    ...
    @mute_logger('etwork.addons.base.models.ir_model', 'etwork.models')
    ...
    @mute_logger('etwork.addons.base.models.ir_model', 'etwork.models', 'etwork.models.unlink')
...
class TestChannelFeatures(TestMailCommon):
    ...
    @mute_logger('etwork.addons.mail.models.mail_mail', 'etwork.models.unlink')
    ...
    @mute_logger('etwork.models.unlink')
...
class TestChannelModeration(TestMailCommon):
    ...
    @mute_logger('etwork.addons.mail.models.mail_channel', 'etwork.models.unlink')
