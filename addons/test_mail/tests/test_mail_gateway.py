...
from etwork import exceptions
from etwork.addons.mail.tests.common import mail_new_test_user
from etwork.addons.test_mail.data import test_mail_data
from etwork.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from etwork.addons.test_mail.models.test_mail_models import MailTestGateway
from etwork.addons.test_mail.tests.common import TestMailCommon
from etwork.tests import tagged
from etwork.tests.common import users
from etwork.tools import email_split_and_format, formataddr, mute_logger
...
class TestEmailParsing(TestMailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('etwork.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:etwork.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.etwork.com (Mail Delivery System)',
            email_to='bounce@xxx.etwork.com',
            delivered_to='bounce@xxx.etwork.com'
        )
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('etwork.addons.mail.models.mail_thread', 'etwork.models')
    ...
    @mute_logger('etwork.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not etworkbot: added as follower """
        ...
        etworkbot = self.env.ref('base.partner_root')
        etworkbot.active = True
        etworkbot.email = 'etworkbot@example.com'
        with self.mock_mail_gateway():
    ...
    @mute_logger('etwork.addons.mail.models.mail_thread', 'etwork.models.unlink', 'etwork.addons.mail.models.mail_mail')
    ...
    @mute_logger('etwork.addons.mail.models.mail_thread', 'etwork.addons.mail.models.mail_mail', 'etwork.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by etwork should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        etwork should update thread accordingly. Special case when the
