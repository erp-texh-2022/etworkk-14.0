...
from etwork.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from etwork.addons.test_mail.models.test_mail_models import MailTestSimple
from etwork.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from etwork.api import call_kw
from etwork.exceptions import AccessError
from etwork.tests import tagged
from etwork.tools import mute_logger, formataddr
...
class TestMessagePost(TestMailCommon, TestRecipients):
    ...
    def test_post_inactive_follower(self):
        # In some case etworkbot is follower of a record.
        # Even if it shouldn't be the case, we want to be sure that etworkbot is not notified
        (self.user_employee | self.user_admin).write({'notification_type': 'inbox'})
    ...
    @mute_logger('etwork.addons.mail.models.mail_mail', 'etwork.tests')
    ...
    @mute_logger('etwork.addons.mail.models.mail_mail', 'etwork.addons.mail.models.mail_thread')
