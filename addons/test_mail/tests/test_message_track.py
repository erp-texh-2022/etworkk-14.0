...
from etwork.tests.common import tagged
from etwork.tests import Form
...
class TestTracking(TestMailCommon):
    ...
    def test_create_partner_from_tracking_multicompany(self):
        ...
        with patch('etwork.addons.mail.models.mail_thread.MailThread._message_track_post_template', patched_message_track_post_template):
