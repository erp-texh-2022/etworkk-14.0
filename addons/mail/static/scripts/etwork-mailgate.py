...
# etwork-mailgate
#
# This program will read an email from stdin and forward it to etwork. Configure
# a pipe alias in your mail server to use it, postfix uses a syntax that looks
# like:
#
# email@address: "|/home/etwork/src/etwork-mail.py"
#
# while exim uses a syntax that looks like:
#
# *: |/home/etwork/src/etwork-mail.py
#
