...
from etwork import _, api, fields, models, tools
from etwork.addons.bus.models.bus_presence import AWAY_TIMER
from etwork.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class Partner(models.Model):
    ...
    def _compute_im_status(self):
        ...
        etworkbot = self.env['res.partner'].browse(etworkbot_id)
        if etworkbot in self:
            etworkbot.im_status = 'bot'
