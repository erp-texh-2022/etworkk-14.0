etwork.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.etwork.__DEBUG__.services['web.core'].bus;
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = etwork.__DEBUG__.services['root.widget'];
...
// Translation for etwork
$.summernote.lang.etwork = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),
