...
Also, adds methods to convert values back to etwork models.
"""
...
import etwork.modules

from etwork import api, models, fields
from etwork.tools import ustr, posix_to_ldml, pycompat
from etwork.tools import html_escape as escape
from etwork.tools.misc import get_lang, babel_locale_parse
from etwork.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = etwork.modules.get_module_resource(
