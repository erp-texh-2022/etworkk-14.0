...
class PosPaymentMethod(models.Model):
    ...
    def onchange_use_payment_terminal(self):
        for payment_method in self:
            if payment_method.use_payment_terminal == 'etwork_adyen' and payment_method.adyen_terminal_id:
    ...
    def proxy_adyen_request(self, data, operation=False):
        ...
        if self.use_payment_terminal == 'etwork_adyen':
            return self._proxy_adyen_request_etwork_proxy(data, operation)
        else:
    ...
    def _proxy_adyen_request_etwork_proxy(self, data, operation):
        try:
