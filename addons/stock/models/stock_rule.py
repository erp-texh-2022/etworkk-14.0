...
from etwork import SUPERUSER_ID, _, api, fields, models, registry
from etwork.exceptions import UserError
from etwork.osv import expression
from etwork.tools import float_compare, float_is_zero, html_escape
from etwork.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product):
        ...
        :type product: :class:`~etwork.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~etwork.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
