...
from etwork import SUPERUSER_ID, _, api, fields, models
from etwork.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from etwork.exceptions import UserError
from etwork.osv import expression
from etwork.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime
from etwork.tools.float_utils import float_compare, float_is_zero, float_round
from etwork.tools.misc import format_date
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, etwork will automatically pre-fill the detailed "
