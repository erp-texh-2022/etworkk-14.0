...
from etwork import _, fields, models
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@etwork.com; yti@example.com
        # B (id=5): yti@etwork.com; yti@etwork.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@etwork.com              |          1 |        4 |
        #           6 | yti@etwork.com              |          2 |        5 |
        #           5 | yti@example.com           |          1 |        4 |
        #           7 | yti@etwork.com           |          1 |        5 |
        #
