...
from etwork.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('etwork.models', 'etwork.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('etwork.models.unlink', 'etwork.addons.base.models.ir_rule', 'etwork.addons.base.models.ir_model')
