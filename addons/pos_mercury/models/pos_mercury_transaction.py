...
from etwork import models, api, service
from etwork.tools.translate import _
from etwork.exceptions import UserError
from etwork.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "etwork " + service.common.exp_version()['server_version']
