...
wget 'https://nightly.etwork.com/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.etwork.com/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/etwork
chown pi:pi /var/log/etwork
chown pi:pi -R /home/pi/etwork/
...
echo "* * * * * rm /var/run/etwork/sessions/*" | crontab -
...
echo "addons/hw_drivers/iot_devices/" > /home/pi/etwork/.git/info/exclude
