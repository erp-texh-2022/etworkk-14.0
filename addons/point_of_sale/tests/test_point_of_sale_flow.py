...
import etwork
from etwork import fields, tools
from etwork.tools import float_compare, mute_logger, test_reports
from etwork.tests.common import Form
from etwork.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('etwork.addons.point_of_sale.models.pos_order'):
