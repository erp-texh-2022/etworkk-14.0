...
from etwork.exceptions import UserError, AccessDenied
from etwork.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but etwork has the label on the account.move.line, so that's a
        # problem !
