...
import logging
import requests
from etwork.addons.google_calendar.models.google_sync import google_calendar_token
from datetime import timedelta


from etwork import api, fields, models, _
from etwork.exceptions import UserError
from etwork.loglevels import exception_to_unicode
from etwork.addons.google_account.models.google_service import GOOGLE_TOKEN_ENDPOINT
from etwork.addons.google_calendar.utils.google_calendar import GoogleCalendarService, InvalidSyncToken
...
class User(models.Model):
    ...
    def _sync_google_calendar(self, calendar_service: GoogleCalendarService):
        ...
        recurrences.with_context(send_updates=send_updates)._sync_etwork2google(calendar_service)
        ...
        (events - synced_events).with_context(send_updates=send_updates)._sync_etwork2google(calendar_service)
