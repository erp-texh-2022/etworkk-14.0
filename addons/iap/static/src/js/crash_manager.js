etwork.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "etwork.addons.iap.tools.iap_tools.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_etwork_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
