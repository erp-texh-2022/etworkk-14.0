...
class EventDtPatcher(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.event_dt = patch(
            'etwork.addons.event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_dt = patch(
            'etwork.addons.website_event.models.event_event.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.wevent_main_dt = patch(
            'etwork.addons.website_event.controllers.main.fields.Datetime',
            wraps=FieldsDatetime
        )
        cls.event_date = patch(
            'etwork.addons.event.models.event_event.fields.Date',
            wraps=FieldsDate
        )
        cls.wevent_main_date = patch(
            'etwork.addons.website_event.controllers.main.fields.Date',
            wraps=FieldsDate
        )
