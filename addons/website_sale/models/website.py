...
from etwork.addons.http_routing.models.ir_http import url_for
    ...
    def _get_pricelist_available(self, req, show_visible=False):
        ...
        if not website:
            if self.env.context.get('website_id'):
                ...
                # In the weird case we are coming from the backend (https://github.com/etwork/etwork/issues/20245)
