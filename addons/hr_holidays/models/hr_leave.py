...
from etwork import api, fields, models, SUPERUSER_ID, tools
from etwork.addons.base.models.res_partner import _tz_get
from etwork.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
from etwork.exceptions import AccessError, UserError, ValidationError
from etwork.tools import float_compare, format_date
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from etworkBot (sudo)
