 ...
 */
etwork.define('hr_holidays/static/src/bugfix/bugfix.js', function (require) {
'use strict';

});

// FIXME move me in hr_holidays/static/src/models/partner/partner.js
etwork.define('hr_holidays/static/src/models/partner/partner.js', function (require) {
'use strict';
...
registerFieldPatchModel('mail.partner', 'hr/static/src/models/partner/partner.js', {
     ...
     * String is expected to use etwork's datetime string format
