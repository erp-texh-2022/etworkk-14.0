...
from etwork.tools import mute_logger, test_reports

from etwork.addons.hr_holidays.tests.common import TestHrHolidaysCommon
...
class TestHolidaysFlow(TestHrHolidaysCommon):
    ...
    def test_sql_constraint_dates(self):
        ...
        with mute_logger('etwork.sql_db'):
