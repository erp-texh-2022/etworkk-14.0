...
import etwork.addons.web.controllers.main
from etwork import http, _
from etwork.addons.auth_totp.models.res_users import TRUSTED_DEVICE_SCOPE
...
class Home(etwork.addons.web.controllers.main.Home):
    @http.route(
        '/web/login/totp',
