etwork.define('web.upgrade_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    /**
     * Redirects the user to the etwork-enterprise/uprade page
     *
     * @private
     * @returns {Promise}
     */
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.etwork.com/etwork-enterprise/upgrade?num_users=" + data);
            });
    },
    /**
