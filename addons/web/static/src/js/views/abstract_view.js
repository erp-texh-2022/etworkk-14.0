etwork.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. etwork JS views are the
 ...
 * the word 'view' has historical significance in etwork code, so we replaced the
