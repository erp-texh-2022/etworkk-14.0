(function (exports) {
    ...
    let isEnterprise = etwork.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = etwork.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = etwork.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = etwork.__DEBUG__.services["web.WebClient"];
