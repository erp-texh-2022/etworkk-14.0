etwork.define('web.KeyboardNavigationMixin', function (require) {
    "use strict";
    ...
    var KeyboardNavigationMixin = {
         ...
         * Not all letters should be used as access keys, some of the should be reserved for standard etwork behavior or browser behavior
         *
         * @private
