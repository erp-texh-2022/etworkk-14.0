...
See https://github.com/etwork/owl/blob/master/doc/reference/config.md#mode for more information.`);
            }
        },
    });
    ...
    class Component {
         ...
         *  - it can be patched (useful in etwork ecosystem)
  ...
  `;
    ...
    __info__.url = 'https://github.com/etwork/owl';
