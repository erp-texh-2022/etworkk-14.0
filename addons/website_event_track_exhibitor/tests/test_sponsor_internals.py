...
from etwork.addons.website_event_track.tests.common import TestEventTrackOnlineCommon
from etwork.fields import Datetime as FieldsDatetime
...
class TestSponsorData(TestEventTrackOnlineCommon):
    ...
    def setUpClass(cls):
        ...
        cls.wevent_exhib_dt = patch(
            'etwork.addons.website_event_track_exhibitor.models.event_sponsor.fields.Datetime',
