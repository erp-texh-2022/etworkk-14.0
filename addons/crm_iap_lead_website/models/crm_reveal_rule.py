...
from etwork.addons.crm.models import crm_stage
from etwork.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.etwork.com'
...
class CRMRevealRule(models.Model):
    ...
    # Methods responsible for format response data in to valid etwork lead data
