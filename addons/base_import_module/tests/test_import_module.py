...
from etwork.addons import __path__ as __addons_path__
from etwork.tools import mute_logger
from etwork.tests.common import TransactionCase, HttpCase
...
class TestImportModule(TransactionCase):
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with mute_logger("etwork.addons.base_import_module.models.ir_module"):
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('etwork.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
