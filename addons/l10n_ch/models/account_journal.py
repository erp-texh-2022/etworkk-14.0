...
from etwork.addons.base_iban.models.res_partner_bank import validate_iban
from etwork.addons.base.models.res_bank import sanitize_account_number
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(selection_add=[
        ('ch', 'Switzerland')
    ], ondelete={'ch': lambda recs: recs.write({'invoice_reference_model': 'etwork'})})
