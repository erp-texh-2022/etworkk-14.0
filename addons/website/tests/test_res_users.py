...
from etwork.tests.common import TransactionCase, new_test_user
from etwork.exceptions import ValidationError
from etwork.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('etwork.sql_db'):
