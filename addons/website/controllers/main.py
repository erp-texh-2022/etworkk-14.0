...
from etwork import http, models, fields, _
from etwork.http import request
from etwork.tools import OrderedSet
from etwork.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from etwork.addons.web.controllers.main import Binary
from etwork.addons.portal.controllers.portal import pager as portal_pager
from etwork.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': etwork.service.common.exp_version()
        }
