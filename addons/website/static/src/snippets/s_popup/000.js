etwork.define('website.s_popup', function (require) {
'use strict';
...
$.fn.modal.Constructor.prototype._showElement = function () {
    ...
    if (this._element.classList.contains('s_popup_no_backdrop')) {
        ...
        // opened is a very specific etwork behavior.
        ...
        this._etworkLoadEventCaptureHandler = _.debounce(() => _updateScrollbar({ data: this }, 100));
        this._element.addEventListener('load', this._etworkLoadEventCaptureHandler, true);
...
$.fn.modal.Constructor.prototype._hideModal = function () {
    ...
    if (this._etworkLoadEventCaptureHandler) {
        this._element.removeEventListener('load', this._etworkLoadEventCaptureHandler, true);
        delete this._etworkLoadEventCaptureHandler;
    }
};
