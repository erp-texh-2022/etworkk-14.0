etwork.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = publicWidget.Widget.extend(MobileYoutubeAutoplayMixin, {
    ...
    start: function () {
        ...
        // integrated with etwork (this refactoring should be done in master).
        ...
        // videos added before bug fixes or new etwork versions where the
 ...
 * shapes in future etwork versions.
 *
 * /!\
