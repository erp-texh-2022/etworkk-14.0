...
from etwork import registry, SUPERUSER_ID
from etwork.http import request
from etwork.tools.safe_eval import safe_eval
from etwork.osv.expression import FALSE_DOMAIN
from etwork.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
...
def get_request_website():
    ...
    ```
    from etwork.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting etwork.com/fr_BE/),
