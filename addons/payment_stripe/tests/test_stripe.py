...
class StripeTest(StripeCommon):
    ...
    def run(self, result=None):
        with mute_logger('etwork.addons.payment.models.payment_acquirer', 'etwork.addons.payment_stripe.models.payment'):
    ...
    @patch('etwork.addons.payment_stripe.models.payment.request')
    @patch('etwork.addons.payment_stripe.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_etwork_tx(self):
        stripe_object = stripe_mocks.checkout_session_object
