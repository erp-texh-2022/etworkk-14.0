etwork.define('account.upload.bill.mixin', function (require) {
"use strict";
...
etwork.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
etwork.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
