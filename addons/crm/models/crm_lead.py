...
from etwork import api, fields, models, tools, SUPERUSER_ID
from etwork.osv import expression
from etwork.tools.translate import _
from etwork.tools import email_re, email_split
...
PLS_COMPUTE_BATCH_STEP = 50000  # etwork.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
