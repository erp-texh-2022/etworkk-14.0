...
class TestRedirect(HttpCase):
    ...
    def setUp(self):
        ...
        self.base_url = "http://%s:%s" % (HOST, etwork.tools.config['http_port'])
    ...
    @mute_logger('etwork.addons.http_routing.models.ir_http')  # mute 403 warning
    def test_02_redirect_308_RequestUID(self):
        ...
        WebsiteHttp = etwork.addons.website.models.ir_http.Http
