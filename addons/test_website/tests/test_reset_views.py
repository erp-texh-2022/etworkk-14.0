...
class TestWebsiteResetViews(etwork.tests.HttpCase):
    ...
    @mute_logger('etwork.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('etwork.addons.http_routing.models.ir_http', 'etwork.addons.website.models.ir_ui_view')
