...
from etwork.tests.common import SavepointCase, new_test_user
...
class TestAccessRights(SavepointCase):
    ...
    @classmethod
    @mute_logger('etwork.tests', 'etwork.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    @mute_logger('etwork.addons.base.models.ir_rule')
