...
from etwork.addons.payment_ingenico.controllers.main import OgoneController
from etwork.addons.payment_ingenico.data import ogone
from etwork.http import request
from etwork.tools import DEFAULT_SERVER_DATE_FORMAT, ustr
from etwork.tools.float_utils import float_compare, float_repr, float_round
...
class PaymentAcquirerOgone(models.Model):
    ...
    def _ogone_generate_shasign(self, inout, values):
        ...
        :param string inout: 'in' (etwork contacting ogone) or 'out' (ogone
                             contacting etwork). In this last case only some
