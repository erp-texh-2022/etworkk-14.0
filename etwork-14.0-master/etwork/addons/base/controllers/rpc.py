...
from etwork.http import Controller, dispatch_rpc, request, route
from etwork.service import wsgi_server
from etwork.fields import Date, Datetime
from etwork.tools import lazy, ustr
from etwork.tools.misc import frozendict
...
class DosytMarshaller(xmlrpc.client.Marshaller):
    ...
    # Historically, etwork is sending binary as base64 string.
