...
from etwork import api, models, tools
from etwork.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from etwork.tools.misc import get_lang
from etwork.http import request
from etwork.modules.module import get_resource_path

from etwork.addons.base.models.qweb import QWeb, Contextifier
from etwork.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from etwork.addons.web.controllers.main import module_boot
