# -*- coding: utf-8 -*-
from etwork.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
...
class TestUBLBE(TestUBLCommon):
    ...
    def test_export_import_invoice(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_etwork/bis3_out_invoice.xml',
        )
    ...
    def test_export_import_refund(self):
        ...
        xml_etree, xml_filename = self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_etwork/bis3_out_refund.xml',
        )
    ...
    def test_sending_to_public_admin(self):
        ...
        self._assert_invoice_attachment(
            ...
            ''',
            expected_file='from_etwork/bis3_out_invoice_public_admin.xml',
        )
    ...
    def test_rounding_price_unit(self):
        ...
        * Invoice line net amount shall be rounded to two decimals
        ...
        self._assert_invoice_attachment(invoice, None, 'from_etwork/bis3_out_invoice_rounding.xml')
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(invoice, None, 'from_etwork/bis3_ecotaxes_case1.xml')
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice, None, 'from_etwork/bis3_ecotaxes_case2.xml')
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice, None, 'from_etwork/bis3_ecotaxes_case3.xml')
    ...
    def test_import_and_create_partner_ubl(self):
        ...
        self.update_invoice_from_file(
            ...
            subfolder='tests/test_files/from_etwork',
