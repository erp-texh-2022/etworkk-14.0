...
import etwork
from etwork.tools.misc import DotDict
...
def MockRequest(
    ...
    with contextlib.ExitStack() as s:
        etwork.http._request_stack.push(request)
        s.callback(etwork.http._request_stack.pop)
        s.enter_context(patch('etwork.http.root.get_db_router', router))
