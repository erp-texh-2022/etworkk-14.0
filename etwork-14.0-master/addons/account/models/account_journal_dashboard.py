...
from etwork import models, api, _, fields
from etwork.osv import expression
from etwork.release import version
from etwork.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from etwork.tools.misc import formatLang, format_date as etwork_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': etwork_format_date(self.env, activity.get('date_deadline'))
                }
