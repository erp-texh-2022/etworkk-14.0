...
from etwork.exceptions import RedirectWarning, UserError, ValidationError, AccessError
from etwork.tools import float_compare, date_utils, email_split, email_re, float_is_zero
from etwork.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_etwork_invoice(self):
    ...
    def _get_invoice_reference_etwork_partner(self):
        """ This computes the reference based on the Dosyt format.
