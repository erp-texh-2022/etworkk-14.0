...
import etwork.addons.iap.tools.iap_tools
from etwork import http, tools
from etwork.http import request
from etwork.tools.misc import formatLang
...
class MailClientExtensionController(http.Controller):
    ...
    def auth_access_token(self, auth_code, **kw):
        ...
        scope = 'etwork.plugin.' + auth_message.get('scope', '')
    ...
    def _get_auth_code_data(self, auth_code):
        ...
        signature = etwork.tools.misc.hmac(request.env(su=True), 'mail_client_extension', data).encode()
    ...
    def _generate_auth_code(self, scope, name):
        ...
        signature = etwork.tools.misc.hmac(request.env(su=True), 'mail_client_extension', auth_message).encode()
    ...
    def _iap_enrich(self, domain):
        ...
        #except etwork.addons.iap.models.iap.InsufficientCreditError as ice:
        except etwork.addons.iap.tools.iap_tools.InsufficientCreditError:
