...
from etwork.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from etwork.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMassMailing(TestMassMailCommon):
    ...
    def test_mailing_gateway_update(self):
        ...
        self.assertMailTraces(
            ...
            mailing, recipients,
            mail_links_info=[[
                ('url0', 'https://www.etwork.tz/my/%s' % record.name, True, {}),
                ...
                ('url7', 'mailto:test@etwork.com', False, {}),
        ...
        # simulate a click
        self.gateway_mail_click(mailing, recipients[0], 'https://www.etwork.be')
