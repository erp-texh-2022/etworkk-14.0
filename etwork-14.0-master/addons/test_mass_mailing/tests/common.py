...
<span>Website0: <a id="url0" href="https://www.etwork.tz/my/${object.name}">https://www.etwork.tz/my/${object.name}</a></span>
<span>Website1: <a id="url1" href="https://www.etwork.be">https://www.etwork.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@etwork.com">test@etwork.com</a></span>
