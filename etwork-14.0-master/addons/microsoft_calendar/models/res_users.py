...
import logging
import requests
from etwork.addons.microsoft_calendar.models.microsoft_sync import microsoft_calendar_token
...
from etwork.addons.microsoft_account.models.microsoft_service import MICROSOFT_TOKEN_ENDPOINT
from etwork.addons.microsoft_calendar.utils.microsoft_calendar import InvalidSyncToken
...
class User(models.Model):
    ...
    def _sync_microsoft_calendar(self):
        ...
        (events - synced_events)._sync_etwork2microsoft()
