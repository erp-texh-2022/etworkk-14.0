...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('etwork.models.unlink', 'etwork.tests', 'etwork.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('etwork.tests', 'etwork.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('etwork.tests', 'etwork.addons.mail.models.mail_mail', 'etwork.models.unlink')
