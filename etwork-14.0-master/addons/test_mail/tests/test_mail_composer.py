...
from etwork.addons.test_mail.models.test_mail_models import MailTestTicket
from etwork.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from etwork.tests import tagged
from etwork.tests.common import users, Form
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('etwork.models.unlink', 'etwork.addons.mail.models.mail_mail')
