...
from etwork import http, tools, _, SUPERUSER_ID
from etwork.addons.http_routing.models.ir_http import slug
from etwork.exceptions import UserError
from etwork.modules.module import get_module_path, get_resource_path
from etwork.tools.misc import file_open

from ..models.ir_attachment import SUPPORTED_IMAGE_MIMETYPES

logger = logging.getLogger(__name__)
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.etwork.com'
