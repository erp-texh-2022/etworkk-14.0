etwork.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in etwork.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" etwork domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in etwork.
 */
...
/**
 * Let users choose a document, including uploading a new document in etwork.
 */
