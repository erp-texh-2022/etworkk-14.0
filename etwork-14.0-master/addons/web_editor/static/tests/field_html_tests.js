etwork.define('web_editor.field_html_tests', function (require) {
"use strict";
    ...
    <div class="o_notebook">
      <div class="tab-content">
        ...
        QUnit.test('colorpicker', async function (assert) {
            ...
            const rootWidget = etwork.__DEBUG__.services['root.widget'];
            etwork.__DEBUG__.services['root.widget'] = form.getParent();
            ...
            etwork.__DEBUG__.services['root.widget'] = rootWidget;
            form.destroy();
        });
