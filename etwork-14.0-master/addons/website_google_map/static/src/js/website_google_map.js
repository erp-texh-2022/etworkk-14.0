function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('etwork-google-map'), {
        zoom: 1,
    ...
    if (etwork_partner_data){ /* etwork_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < etwork_partner_data.counter; i++) {
            set_marker(etwork_partner_data.partners[i]);
        }
