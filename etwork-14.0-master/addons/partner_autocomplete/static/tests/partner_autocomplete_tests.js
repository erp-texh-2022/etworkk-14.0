etwork.define('partner_autocomplete.tests', function (require) {
    "use strict";
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "etwork.com/logo.png" ? "etworkbase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "etwork")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "etwork.com/logo.png"
                    || route === "data:image/png;base64,etworkbase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "etwork");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing etwork letters again");
