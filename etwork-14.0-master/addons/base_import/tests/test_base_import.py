...
from etwork.tests.common import TransactionCase, can_import
from etwork.modules.module import get_module_resource
from etwork.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('etwork.addons.base_import.models.base_import')
