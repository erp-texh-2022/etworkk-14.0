...
from etwork.modules.module import get_module_root, MANIFEST_NAMES
from etwork.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            etwork.tools.config['init']['base'] = True
