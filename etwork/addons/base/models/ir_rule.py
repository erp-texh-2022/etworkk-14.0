...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - etwork/addons/test_access_rights/tests/test_feedback.py
        # - etwork/addons/test_access_rights/tests/test_ir_rules.py
        # - etwork/addons/base/tests/test_orm.py (/home/dle/src/etwork/master-nochange-fp/etwork/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
