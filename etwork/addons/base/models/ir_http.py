...
import etwork
from etwork import api, http, models, tools, SUPERUSER_ID
from etwork.exceptions import AccessDenied, AccessError, MissingError
from etwork.http import request, content_disposition
from etwork.tools import consteq, pycompat
from etwork.tools.mimetypes import get_extension, guess_mimetype
from etwork.modules.module import get_resource_path, get_module_path

from etwork.http import ALLOWED_DEBUG_MODES
from etwork.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(etwork.conf.server_wide_modules)
            if tools.config['test_enable'] and etwork.modules.module.current_test:
                installed.add(etwork.modules.module.current_test)
