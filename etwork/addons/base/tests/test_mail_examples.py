...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.etwork.com">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as etwork and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this etwork mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        ...
        <div>
            ...
            Best regards,<br>
            <pre>
                <a href="http://etwork.com" target="_blank">http://etwork.com</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://etwork.com" target="_blank" data-o-mail-quote="1">http://etwork.com</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        OpenERP Enterprise [mailto:sales@etwork.com]
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://etwork.com">http://etwork.com</a><p></p></pre>
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed etwork 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">etwork Error<span class="o_subtitle text-muted"></span></h4>
                </div>
