...
from etwork.addons.base.tests.common import TransactionCaseWithUserDemo
from etwork.exceptions import AccessError, MissingError, UserError, ValidationError
from etwork.tests import common
from etwork.tools import mute_logger, float_repr
from etwork.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(TransactionCaseWithUserDemo):
    ...
    @mute_logger('etwork.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from etwork.addons.base.tests.test_mimetypes import ZIP
    ...
    def test_86_text_base64_guess_svg(self):
        from etwork.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(common.TransactionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('etwork.sql_db'), self.cr.savepoint():
                record_a.unlink()
...
class TestFieldParametersValidation(common.TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('etwork.fields', level='WARNING') as cm:
            self.registry.setup_models(self.env.cr)

        self.assertTrue(cm.output[0].startswith(
            "WARNING:etwork.fields:Field test_new_api.field_parameter_validation.name: "
